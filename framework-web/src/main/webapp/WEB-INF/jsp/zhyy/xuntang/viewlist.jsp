...
<script type="text/javascript">
        ...
        for (var i = 0, j = list.length; i < j; i++) {
            ...
            rows.push({
                cell:{
                    ...
                    view:{value:iconImg.editIcon, event:"click", eventFunc:viewZhyyXuntang, customArg:{}, align:"center"}
                }
            });
        }
        return rows;
    ...
    function viewZhyyXuntang(e) {
        ...
        addDialog = new $.dialog({
                    ...
                    height: 600,
                    width: 550,
                    content: 'url:<%=path%>/con/zhyy/xuntang/view?cjriqi='+cjriqi
                });
    }
