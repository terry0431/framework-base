...
<html>
                ...
                <form id="forms">
                    <table class="box_tab_1" >
                        ...
                        <tr>
                            ...
                            <td><textarea cols="40" rows="8" id="XChuliqingkuang" ></textarea></td>
                        </tr> 
                        <tr>
                            <td class="tab1_tit">处理日期：</td>
                            <td><input type="text" id="XChulishijian_date" maxlength="19"  /></td>
                        </tr> 
                        <tr>
                            <td class="tab1_tit">处理时间：</td>
                            <td><input type="text" id="XChulishijian_time" maxlength="19"  /></td>
                        </tr>
                        <tr>
    ...
    $(function () {
        ...
        laydate.render({
                elem: '#XChulishijian_date' //指定元素
                ,max: 0
                ,value: new Date()
            });
        laydate.render({
            elem: '#XChulishijian_time'
            ,type: 'time'
            ,value: new Date()
          });
        if (id != "") {
    ...
    $("#save").click(function () {
        ...
        obj.x_chulishijian = $("#XChulishijian_date").val() + " " + $("#XChulishijian_time").val();
        $.ajax({
            url: url,
