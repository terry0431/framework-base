...
<html>
    <head>
        <%
            ...
            String yzcid = request.getAttribute("yzcid").toString();
            Map ymaap = (Map)request.getAttribute("ymap");
        %>
        <title>在线监测</title>
        ...
        <table width="100%" height="" border="0">
            <tr>
              <td width="100%"  height="30px" bgcolor="#0033FF">
                  <span class="STYLE1"><%=ymaap.get("y_mingcheng")%>—池塘实时在线监测</span>
              </td>
            </tr>
            <tr>
                <td valign="top">
          ...
          <div id="div_content" style="position: fixed;float:left;width:700px;height:203px;right: 45%;top: 30%;background: #0097BD;color:#FFFFFF;font-size: 12px;">
            ...
            <div id="div_chart" style="float:left;width:600px;height:200px;"></div>
          </div>
    </body>
