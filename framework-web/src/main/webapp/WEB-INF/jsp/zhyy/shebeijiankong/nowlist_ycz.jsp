                    ...
                    <div class="box_c">
                        ...
                        <ul class="search">
                            <li>
                                ...
                                <div class="left mlr5">
                                    <select><option>营城子</option></select>
                                </div>
                            </li>
                        </ul>
                        <ul class="search">
                        ...
                        <table  id="datatable_ysj" width="90%"  align="center">
                        </table>
                    </div>
            </div>
        </div>
...
<script type="text/javascript">
    var sb_sbjk_url = "/framework-web/ifs/zhyy/shebeijiankong/nowlist?id=2";
    var yzcnum = 2;
    var retime = 1000 * 10;
    ...
    function init_table() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var str = "<tr><th width=\"10%\">采集时间</th>"
                for (var i = 0; i < yzcnum; i++) {
                    str += "<th width=\"45%\">" + (i + 1) + "号设备</th>";
                }
                str += "</tr>";
                        ...
                        if(data[i] != null && data[i].length > 0){
                            for (j = 0; j < data[i].length; j++) {
                                if (data[i][j].s_flag == "1") {
                                    ...
                                    iconsrc = iconImg.checkBoxIcon + "电流:"+data[i][j].s_dianliu + "&nbsp;&nbsp;泵状态:" +  data[i][j].s_bengzhuangtai + "&nbsp;&nbsp;输出:" +  data[i][j].s_shuchu;
                                } else{
                            ...
                            str += "<td width=\"90%\" align=\"center\" colspan=\"22\">暂无数据</td>";
                        }
                        str += "</tr>";
