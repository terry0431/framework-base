...
import com.os.framework.web.bean.bundle.sms.SMSBean;
...
public class ShebeiJiankong_ycz implements Job{
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
            String sql = "select * from zhyy_shebeijiankong where s_year=? and s_month=? and s_day=? and s_hour=? and zhyy_yangzhichang_id=2";
            List<Map<String, Object>> datalist = dao.queryForList(sql, new Object[]{year, month, day, hour});
            if (datalist == null || datalist.size() == 0) {
                for (int i = 24; i < 24 + sbnum; i++) {
                    ...
                    dataobj.put("zhyy_yangzhichang_id", "2");
                    dataobj.put("zhyy_yangzhiqu_id", i - 23);
                    ...
                    try {
                        ...
                        if(dataobj.get("s_baojing").toString().equals("-1") && dataobj.get("is_youxiao").toString().equals("1")){
                            ...
                            if(lxr == null || mobile == null){
                                sql = "select * from zhyy_yangzhichang where id = 2";
