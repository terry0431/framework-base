package com.os.framework.transceriver.subscribe;

import com.os.framework.core.config.HostInfo;
import com.os.framework.transceriver.subscribe.handler.SubscribeHandler;
...
//                            socketChannel.pipeline().addLast(new JSONEncoder());
            ...
            ChannelFuture channelFuture = client.connect(HostInfo.HOST_NAME, HostInfo.TRANSCERVIER_POST).sync();
